...
class Server {
  ...
  routes() {
    ...
    // Groupe
    new routes.groupe.createGroupe(this.app, this.connect)
    new routes.groupe.showGroupe(this.app, this.connect)
    new routes.groupe.updateGroupe(this.app, this.connect)
    new routes.groupe.deleteGroupe(this.app, this.connect)
    ...
    // Shopping 
    new routes.shopping.createShopping(this.app, this.connect)
    new routes.shopping.showShopping(this.app, this.connect)
    new routes.shopping.deleteShopping(this.app, this.connect)
    new routes.shopping.updateShopping(this.app, this.connect)
