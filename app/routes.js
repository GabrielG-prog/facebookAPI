...
// Groupe
const createGroupe = require('./controllers/groupe/create')
const showGroupe = require('./controllers/groupe/show')
const deleteGroupe = require('./controllers/groupe/delete')
const updateGroupe = require('./controllers/groupe/update')
...
// Shopping
const createShopping = require('./controllers/shopping/create')
const showShopping = require('./controllers/shopping/show')
const deleteShopping = require('./controllers/shopping/delete')
const updateShopping = require('./controllers/shopping/update')
